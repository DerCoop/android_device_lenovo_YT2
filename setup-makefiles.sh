...
#ifeq (\$(TARGET_DEVICE),YT2)
# XMSX disabled during build errors (missing APKs)
ifeq (\$(TARGET_DEVICE),FALSE)

include \$(CLEAR_VARS)
LOCAL_MODULE := com.intel.widi.sink
LOCAL_MODULE_OWNER := $VENDOR
LOCAL_SRC_FILES := proprietary/framework/com.intel.widi.sink.jar
